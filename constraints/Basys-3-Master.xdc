...
set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33 } [get_ports {i_echo_sig}];#Sch name = JA3
set_property -dict { PACKAGE_PIN G2   IOSTANDARD LVCMOS33 } [get_ports {o_trig_sig}];#Sch name = JA4
